"""
FLUIDTEST
A test to see if fluids can be simulated. Not much is changed besides some optimizations and size.
"""
...
def collide(p1,p2):
  ...
  if dist <p1.size + p2.size:
    ...
    angle = math.pi#+tangent
    angle1 = p1.angle#tangent  -p1.angle
    angle2 = #tangent - p2.angle  #*2 is missing 
    speed1 = p2.speed 
    speed2 = p1.speed
